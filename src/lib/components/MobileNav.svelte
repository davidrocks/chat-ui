...
<nav
	class="mx-3 mt-4 flex h-12 items-center justify-between rounded-b-xl border-b bg-gray-50 px-2 dark:border-gray-800 dark:bg-gray-800/30 dark:shadow-xl max-md:rounded-xl max-md:border md:hidden"
>
	<button
		type="button"
